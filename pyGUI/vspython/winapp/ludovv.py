...
#safe button
b_safe1=Button(r2,text="safe",bd=10,padx=10,pady=5,bg="#ffff00")
#safe button
...
#left column
b21=Button(r2,text="21",padx=23,pady=15,border=0)
b22=Button(r2,text="22",padx=24,pady=15,border=0)
b23=Button(r2,text="23",padx=25,pady=15,border=0)
b24=Button(r2,text="24",padx=25,pady=15,border=0)
b25=Button(r2,text="25",padx=25,pady=15,border=0)

b26=Button(r2,text="26",padx=25,pady=15,border=0)
b27=Button(r2,text="27",padx=25,pady=15,border=0)
b28=Button(r2,text="28",padx=25,pady=15,border=0)
b29=Button(r2,text="29",padx=25,pady=15,border=0)
b30=Button(r2,text="30",padx=25,pady=15,border=0)
#2-row
b_safe2=Button(r2,text="safe",bd=10,padx=10,pady=10,bg="#ffff00")
#safe button
b31=Button(r2,text="11",padx=23,pady=15,border=0)
b32=Button(r2,text="12",padx=24,pady=15,border=0)
b33=Button(r2,text="13",padx=25,pady=15,border=0)
b34=Button(r2,text="14",padx=25,pady=15,border=0)
b35=Button(r2,text="15",padx=25,pady=15,border=0)

b36=Button(r2,text="16",padx=25,pady=15,border=0)
b37=Button(r2,text="17",padx=25,pady=15,border=0)
b38=Button(r2,text="18",padx=25,pady=15,border=0)
b39=Button(r2,text="19",padx=25,pady=15,border=0)
b40=Button(r2,text="20",padx=25,pady=15,border=0)
...
#2 row
b21.grid(row=1,column=20,padx=3)
b22.grid(row=1,column=19,padx=3)
b23.grid(row=1,column=18,padx=3)
b24.grid(row=1,column=17,padx=3)
b25.grid(row=1,column=16,padx=3)

b26.grid(row=1,column=15,padx=3)
b27.grid(row=1,column=14,padx=3)
b28.grid(row=1,column=13,padx=3)
b29.grid(row=1,column=12,padx=3)
b30.grid(row=1,column=11,padx=3)
#2 row-safe
b_safe2.grid(row=1,column=10,padx=20)
#2row
b31.grid(row=1,column=9,padx=3)
b32.grid(row=1,column=8,padx=3)
b33.grid(row=1,column=7,padx=3)
b34.grid(row=1,column=6,padx=3)
b35.grid(row=1,column=5,padx=3)

b36.grid(row=1,column=4,padx=3)
b37.grid(row=1,column=3,padx=3)
b38.grid(row=1,column=2,padx=3)
b39.grid(row=1,column=1,padx=3)
b40.grid(row=1,column=0,padx=3)
